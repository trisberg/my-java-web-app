...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=trisberg&repo=my-java-web-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=trisberg&repo=my-java-web-app'
